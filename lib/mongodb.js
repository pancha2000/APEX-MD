// lib/mongodb.js (මෙය කලින් database.js ලෙස තිබූ කේතයයි, දැන් mongodb.js ලෙසම පවතී)
...
const defaultEnvVariables = [
    { key: 'ALIVE_IMG', value: 'https://imgur.com/a/JVLUBdD' },
...
// --- මෙතැනදී සියලු functions export කරන්න ---
module.exports = {
    connectDB,
    readEnv,
    updateEnv,
